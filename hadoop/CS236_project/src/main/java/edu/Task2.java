...
public class Task2 {
    ...
    public static class TokenizerMapper
        ...
        public void map(Object key, Text value, Context context
            ...
            String group = tokens[1].trim() + ":" + tokens[3].trim(); 

            String variable_to_sum_11 = "GROCPTH11";
            String variable_to_sum_16 = "GROCPTH16";

            if (tokens[3].equals(variable_to_sum_11) || tokens[3].equals(variable_to_sum_16)){
                try {

                    double colValue = Double.parseDouble(tokens[4]);
    ...
    public static class TokenizerMapper2
        ...
        public void map(Object key, Text value, Context context
            ...
            try {
                ...
                double colValue = Double.parseDouble(tokens[1].trim());

                groupKey.set(group);
                outputValue.set(colValue);
                //  System.out.println("Key "+ groupKey.toString() +" Value "+ Double.toString(outputValue.get()));
